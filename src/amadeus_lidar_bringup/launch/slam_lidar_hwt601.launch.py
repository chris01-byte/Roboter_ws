...
def _require_stationary_confirmation(context):
    if LaunchConfiguration('operator_stationary_confirmed').perform(context) != 'true':
        raise RuntimeError('HWT-Start braucht aktuell bestaetigten realen Stillstand')
    return []
